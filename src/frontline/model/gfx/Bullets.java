...
public class Bullets implements Component{
    ...
    public void add(Vector2 origin, Vector2 mousePos, int accuracy){
        ...
        double angle = Services.getAngle(origin.X - Services.camera.x, origin.Y - Services.camera.y, mousePos.X, mousePos.Y);
        angle += 90;
    ...
    public boolean isOutOfBounds(Bullet bill){
        return bill.position.X >Services.screenWidth + Services.leftInset + Services.rightInset || bill.position.X < Services.leftInset ||
