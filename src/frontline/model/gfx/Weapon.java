...
public class Weapon{
   ...
   public void setDirection(double angle){
    ...
    public void draw(Graphics2D g, Vector2 position){
        g.drawImage(sheet, 
                (int)position.X - 16 - Services.camera.x, (int)position.Y - Services.camera.y,
                (int)(position.X + getWidth() - 16) - Services.camera.x, (int)(position.Y + getHeight()) - Services.camera.y,
