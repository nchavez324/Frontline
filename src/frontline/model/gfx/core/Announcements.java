...
public class Announcements implements Component{
     ...
     public final String message = "Frontline: Milestone Build 1.5 $ "
    ...
    public void draw(Graphics2D g) {
        if(enemyMeter != null && enemyMeter.percentage <= 0){
            g.drawImage(victory, (Services.screenWidth - victory.getWidth(null))/2, (600 - victory.getHeight(null))/2, null);
        }
        if(playerMeter != null && playerMeter.percentage <= 0){
            g.drawImage(defeat, (Services.screenWidth - defeat.getWidth(null))/2, (600 - defeat.getHeight(null))/2, null);
        }
        if(isPaused){
            g.drawImage(paused, (Services.screenWidth - paused.getWidth(null))/2, (600 - paused.getHeight(null))/2, null);
        }
        if(intro.active){
            intro.draw(g);
        }
