            ...
            if (animation != null) {
                ...
                if (hud) {
                    g.drawImage(animation.sheet,
                            ...
                            null); //Basically it takes an image, a destination rectangle, a source rectangle and an image observer.
                } else {
                    g.drawImage(animation.sheet,
                            (int) position.X - Services.camera.x, (int) position.Y - Services.camera.y,
                            (int) position.X + animation.frameWidth - Services.camera.x, (int) position.Y + getHeight() - Services.camera.y,
                            animation.getRectangle().x, animation.getRectangle().y,
                            animation.getRectangle().x + animation.frameWidth, animation.getRectangle().y + getHeight(),
                            null);
                }
                ...
                if (hud) {
                    ...
                    g.drawImage(singleImg, (int) position.X - Services.camera.x, (int) position.Y - Services.camera.y, null); //Draws straight from the lonely image.  
                }
            }
        }
    }
