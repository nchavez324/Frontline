...
public class Prompt extends Sprite implements Component{
    ...
    public Prompt(String text){
        loadResources();
        this.text = text;
        position.X = ((Services.screenWidth-width)/2) + Services.leftInset - Services.rightInset;
        position.Y = ((Services.screenHeight-height)/2) + Services.topInset - Services.bottomInset;
