...
public class WeaponBase {
    ...
    public void draw(Graphics2D g){
        g.drawImage(weaponBase,
        		Services.leftInset + Services.screenWidth - (weaponBase.getWidth(null) * 2), Services.screenHeight- (weaponBase.getHeight(null) * 2),
        		Services.screenWidth, Services.screenHeight,
                0, 0,
        ...
        g.drawImage(weaponImage, 
        		Services.leftInset + Services.screenWidth - (weaponBase.getWidth(null) * 2) + 225, Services.screenHeight - (weaponBase.getHeight(null) * 2) - 30,
        		Services.leftInset + Services.screenWidth - (weaponBase.getWidth(null) * 2) + 225 + (weaponImage.getWidth(null) * 2), Services.screenHeight - (weaponBase.getHeight(null) * 2) + (weaponImage.getHeight(null) * 2) - 30,
                0, 0,
    ...
    public void drawWeaponName(Graphics2D g){
        ...
        int x = (165 - (int)(rect.getWidth()))  / 2 + Services.leftInset + Services.screenWidth - ((weaponBase.getWidth(null) * 2)) + 33;
        int y = (15 - (int)(rect.getHeight())) / 2  + fm.getAscent() + Services.screenHeight - (weaponBase.getHeight(null) * 2) + 2;
    ...
    public void drawWeaponAmmoCount(Graphics2D g){
        ...
        int x = (165 - (int)(rect.getWidth()))  / 2 + Services.leftInset + Services.screenWidth - ((weaponBase.getWidth(null) * 2)) + 33;
        int y = (15 - (int)(rect.getHeight())) / 2  + fm.getAscent() + Services.screenHeight - (weaponBase.getHeight(null) * 2) + 2 + 30;
    ...
    public void initSets(){
        ...
        for(int i = 0; i < stock.length; i++){
            ...
            sets[i].position = new Vector2(Services.leftInset + Services.screenWidth - (weaponBase.getWidth(null) * 2) + 35 - (sets[i].getWidth()) + 3, Services.screenHeight - (weaponBase.getHeight(null) * 2) + 25);
        }
        ammo = sets[0];
    }
}
