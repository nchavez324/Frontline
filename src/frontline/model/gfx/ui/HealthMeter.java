...
public class HealthMeter {
    ...
    public void draw(Graphics2D g){
        ...
        if(percentage > 0){
        g.drawImage(fill,
                (int)((60 - (((100 - percentage)/100)) * ((fill.getWidth(null)*2) - 10))),Services.screenHeight - (base.getHeight(null) * 2) + 18,
                (int)((Services.leftInset + (fill.getWidth(null) * 2) + 60 - (((100 - percentage)/100)) * ((fill.getWidth(null) * 2) - 10))), Services.screenHeight - (base.getHeight(null) * 2) + 18 + (fill.getHeight(null) * 2),
                0, 0,
                fill.getWidth(null), fill.getHeight(null),
                null);
        }
        g.drawImage(mask,
        		Services.leftInset, Services.screenHeight - (mask.getHeight(null) * 2),
        		Services.leftInset + (mask.getWidth(null) * 2), Services.screenHeight,
                0, 0,
