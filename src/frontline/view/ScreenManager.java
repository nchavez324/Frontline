...
public class ScreenManager {
    ...
    */
    ...
    public synchronized void setUpWindow() {
        ...
        frame.setSize(Services.screenWidth,Services.screenHeight);  //Sets size. This is the best size possible.
        ...
        frame.setSize(Services.screenWidth + frame.getInsets().right, Services.screenHeight + frame.getInsets().bottom); //Adjusts for OS's window borders. 
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
