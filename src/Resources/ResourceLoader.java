...
public class ResourceLoader {
    ...
    public static String[] etcFiles = {
        "ammoicon", "defeat", "emptyammoicon", "paused", "victory", "bg", "opening", "stdbackground", "options"
    };
    public static String[] uiFiles = {
        "ammoicon", "emptyammoicon", "footer", "healthbase", "healthfill", "healthmask", "otherBar", "otherFill",
        "shot", "unshot", "weaponbase", "reloadIcon", "backColor", "frontColor", "bloodMask", "PressEnter",
        "button", "fontnums", "16icon", "32icon"
    };
